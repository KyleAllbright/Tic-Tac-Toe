...
namespace TicTacToe
{
    ...
    public partial class MainWindow : Window
    {
        ...
        /// <summary>
        /// True if it is player 1's turn (X) or play 2's turn (O)
        /// </summary>
        ...
        /// <summary>
        /// Starts a new game and clears all values back to their defaults
        /// </summary>
        private void NewGame()
        {
            ...
            // Make sure it is player ones turn
            mPlayer1Turn = true;

            // Iterate every button on the grid
            Container.Children.Cast<Button>().ToList().ForEach(b =>
            {
                // Change content, background and foreground to default values
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            // Don't do anything if the cell is already populated
